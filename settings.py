...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "WELCOME_MESSAGE")
REPLY_TO_THIS_MESSAGE = os.getenv("REPLY_TO_THIS_MESSAGE", "REPLY_TO_THIS")
WRONG_REPLY = os.getenv("WRONG_REPLY", "WRONG_REPLY")
FAQ_MESSAGE = os.getenv("FAQ_MESSAGE", "FAQ_MESSAGE")
QUESTION_MESSAGE = os.getenv("QUESTION_MESSAGE", "QUESTION_MESSAGE")
